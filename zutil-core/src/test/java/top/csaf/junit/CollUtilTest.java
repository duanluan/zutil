...
class CollUtilTest {
  ...
  void isAnyEmpty() {
    ...
    assertFalse(CollUtil.isAnyEmpty(list.iterator()));
    list.add(null);
    ...
    assertFalse(CollUtil.isAnyEmpty(Collections.singletonMap("1", 1)));
    assertTrue(CollUtil.isAnyEmpty(new Object[]{null}));
    assertFalse(CollUtil.isAnyEmpty(new Object[]{1}));
    assertTrue(CollUtil.isAnyEmpty(new Vector<>(list).elements()));
    assertFalse(CollUtil.isAnyEmpty(new Vector<>(Collections.singletonList(1)).elements()));
  }
  ...
  @DisplayName("CollUtil 剩余分支")
  @Test
  void remainingBranches() {
    assertThrows(IllegalArgumentException.class, () -> CollUtil.isAllEmpty(1));
    assertThrows(IllegalArgumentException.class, () -> CollUtil.isAnyEmpty(1));
    assertFalse(CollUtil.contains(null, 1));
    assertFalse(CollUtil.contains(new ArrayList<>(), 1));
    assertFalse(CollUtil.contains(Collections.singletonList(1), 2));

    Iterable<Integer> iterable = () -> Arrays.asList(1, 2).iterator();
    assertTrue(CollUtil.isAllEqualsSameIndex(true, null, iterable, new Integer[]{1, 2}));
    assertFalse(CollUtil.isAllEqualsSameIndex(true, null, 1, new Integer[]{1}));

    assertTrue(CollUtil.isAllEquals(true, null, new int[]{1, 1}, new int[]{1}));
    assertTrue(CollUtil.isAllEquals(true, null, new long[]{1, 1}, new long[]{1}));
    assertTrue(CollUtil.isAllEquals(true, null, new double[]{1, 1}, new double[]{1}));
    assertTrue(CollUtil.isAllEquals(true, null, new float[]{1, 1}, new float[]{1}));
    assertTrue(CollUtil.isAllEquals(true, null, new char[]{'1', '1'}, new char[]{'1'}));
    assertTrue(CollUtil.isAllEquals(true, null, new byte[]{1, 1}, new byte[]{1}));
    assertTrue(CollUtil.isAllEquals(true, null, new boolean[]{true, true}, new boolean[]{true}));
    assertTrue(CollUtil.isAllEquals(true, null, new short[]{1, 1}, new short[]{1}));
    assertTrue(CollUtil.isAllEquals(true, null, new Vector<>(Collections.singletonList(1)).elements(), new Object[]{1}));
    assertFalse(CollUtil.isNotAllEquals(true, null, new int[]{1}, new int[]{1}));

    assertTrue(CollUtil.isAllEqualsSameIndex(true, null, new int[]{1}, new int[]{1}));
    assertTrue(CollUtil.isAllEqualsSameIndex(true, null, new long[]{1}, new long[]{1}));
    assertTrue(CollUtil.isAllEqualsSameIndex(true, null, new short[]{1}, new short[]{1}));
  }
}
